...
**Full mode (`--full`: the small base, 250 anneal steps at 32 × 128, 60 extension steps at 8 × 512; 1,119 s on the shared machine at load ≈ 10–15, roughly 6–8 minutes on a quiet laptop):**
...
--- (a) anneal: 250 steps on the math-heavy mix, LR decaying linearly to 0 ---
   ...
   AFTER:  math loss 1.285 (ppl 3.6) | stories loss 0.714 (ppl 2.0)   [898s]
...
--- (b) long context: 256 -> 512 positions with RoPE theta 50000 ---
   ...
   long-position loss: 1.007 (naive) -> 0.864 (ABF) -> 0.688 (ABF + fine-tune)   [160s]

   final held-out (seq 128): math 1.290 | stories 0.730
5/5 checks passed in 1118.5s
```
